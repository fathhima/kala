...
export interface IInstructorService {
    getPublicInstructors(query: PublicInstructorQueryInput): Promise<IPaginatedResult<PublicInstructorProfile>>;

    getPublicInstructor(profileId: string): Promise<PublicInstructorProfile>;
